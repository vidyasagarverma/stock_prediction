...
mail_content = "Happy Birthday"
#The mail addresses and password
sender_address = 'mattmagha@gmail.com'
sender_pass = ''
receiver_address = 'vidyasagar179627@gmail.com'
#Setup the MIME
...
def pairs_trading_algo():
    ...
    api = tradeapi.REST('PKXDGPIAJ6YR8L9CKQP0', 'QSrkuU0DMhw8XD47bKgWSWx1BnfhmFwUfD2UDbOu', api_version='v2') # or use ENV Vars shown below
...
stock1_barset = api.get_barset('AAPL','day',limit=1000)
stock1_barset
